...
- `benchmarks/pytorch`
    - [Tiny ImageNet](https://www.kaggle.com/c/tiny-imagenet) dataset
        - This dataset is already available on LUMI in HDF5 format and is copied into the
          benchmark directory when running `scripts/run_tests.sh`. On other systems, you need to
